...
// JavaScript Document
		...
		const imageData = [
			{
				title: "On Set with HD Camera",
				description: "Capturing every detail in ultra-high definition for cinematic excellence"
			},
			{
				title: "Sound & Scene Setup",
				description: "Clapperboard ready and headphones wired for perfect audio sync"
			},
			{
				title: "Camera Close-Up",
				description: "Professional gear framing the essence of every shot"
			},
			{
				title: "Invisible Talent",
				description: "Behind the scenes magic — where mystery meets motion"
			},
			{
				title: "Production Rollout",
				description: "Lights, camera, action — kicking off the next big story"
			},
			{
				title: "Gear in Focus",
				description: "The tools that bring imagination to life on screen"
			},
			{
				title: "Voice Sync Studio",
				description: "Recording the soul of the scene with precise dubbing"
			}
		];
